            ...
            if len(self.neighbors) > 1:
                  if self.moral_state == "Corrupted": 
                            ...
                            if len(susceptible_neighbors) > 0:
                                ...
                                if target_neighbor.is_employed == 1 and self.random.random() < 0.2  or target_neighbor.is_employed == 0 and self.random.random() < 0.4:
                                          target_neighbor.moral_state = "Corrupted"
                                          if len(employed_non_corrupted) > 0 and self.random.random() < 0.35:
